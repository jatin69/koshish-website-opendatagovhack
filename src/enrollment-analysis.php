       ...
       <!--
        ...
        <section class="global-page-header">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="block">
                            <h2>Enrollment rate analysis</h2>
                            <ol class="breadcrumb">
                                <li>
                                    <a href="index.html">
        ...
        <section class="company-description">
            <div class="container">
                <div class="row">
                     <!-- division -->
                     <h2>BOYS- GIRLS Enrollment in the past </h2>
                     <h2></h2>
                     <div id="line-example" style=" width: 80% ; height: 60%"></div>
                     <!-- and its script -->
                     ...
                     <script type="text/javascript">
                         new Morris.Line({
                          ...
                          data: [
                            { y: '2001', BOYS: 65,  GIRLS: 60 },
                            { y: '2002', BOYS: 67,  GIRLS: 62 },
                            { y: '2003', BOYS: 69,  GIRLS: 64 },
                            { y: '2004', BOYS: 64,  GIRLS: 60 },
                            { y: '2005', BOYS: 74,  GIRLS: 70 },
                            { y: '2006', BOYS: 77,  GIRLS: 73 },
                            { y: '2007', BOYS: 80, GIRLS: 76 }
                          ],
                          xkey: 'y',
                          ykeys: ['BOYS', 'GIRLS'],
                          labels: ['BOYS enrollment %', 'GIRLS enrollment %']
                        });
                     </script>
                </div>
            </div>
